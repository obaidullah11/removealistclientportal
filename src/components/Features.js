...
const Features = () => {
  const features = [
    ...
    },
    {
      ...
      description: 'Compare verified quotes from trusted removalists and service providers',
    ...
    },
    {
      ...
      description: 'Automated notifications to utilities, services, and government agencies',
